  ...
  <div class="modal-content rounded-4 shadow">
    ...
    <div class="modal-body p-5 pt-0">
      ...
      <form @submit.prevent="emailSignIn">
        ...
        <button class="w-100 btn btn-lg rounded-3 btn-primary" type="submit" :disabled="!email || !password">Sign in</button>
        <RouterLink to="/accounts/register" class="w-100 mt-2 btn btn-lg rounded-3 btn-outline-dark" type="button">Create an account</RouterLink>
        <hr class="my-4" />
