        ...
        <div class="info-box shadow-none">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number">
              <span class="">LINE Messaging API</span>
  ...
  <div class="card shadow-none">
    <div class="card-header">
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="/console/service/{{ $service->service_id }}/line-messaging-api">LINE Messaging API</a>
        </li>
        <li class="nav-item">
    ...
    <div class="card-body">
      ...
      <form id="service-update" action="/console/service/{{ $service->service_id }}/line-messaging-api/update" method="POST">
        @csrf
        ...
        <hr>
        <div class="form-group row">
          <label for="bot_basic_id" class="col-lg-2 col-form-label">Bot basic ID</label>
          <div class="col-lg-10">
            <input type="text" class="form-control @error('bot_basic_id') is-invalid @enderror" id="bot_basic_id" name="bot_basic_id" value="{{ $service_line_messaging_api->bot_basic_id }}" aria-describedby="ServiceHelp">
            @error('bot_basic_id')
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <input type="text" class="form-control @error('channel_id') is-invalid @enderror" id="channel_id" name="channel_id" value="{{ $service_line_messaging_api->channel_id }}" aria-describedby="ServiceHelp">
            @error('channel_id')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="form-group row">
          ...
          <div class="col-lg-10">
            <input type="text" class="form-control @error('channel_secret') is-invalid @enderror" id="channel_secret" name="channel_secret" value="{{ $service_line_messaging_api->channel_secret }}" aria-describedby="ServiceHelp">
        ...
        <hr>
        <div class="form-group row">
          <label for="channel_access_token" class="col-lg-2 col-form-label">Channel access token</label>
          <div class="col-lg-10">
            <input type="text" class="form-control @error('channel_access_token') is-invalid @enderror" id="channel_access_token" name="channel_access_token" value="{{ $service_line_messaging_api->channel_access_token }}" aria-describedby="ServiceHelp">
