            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <div class="input-group col-12 col-md-auto my-3 my-md-0 me-md-3">
                                <form class="">
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                <img src="{{ asset('dist/img/user2-160x160.jpg') }}" alt="User Image" width="32" height="32" class="rounded-circle">
                                <span class="ms-1 d-md-none d-lg-inline">{{ Auth::user()->name }}</span>
                            </a>
