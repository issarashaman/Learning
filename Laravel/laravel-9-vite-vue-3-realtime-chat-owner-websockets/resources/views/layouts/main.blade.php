...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed pace-primary" data-panel-auto-height-mode="height">
    <div class="wrapper">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-header bg-primary">
                            ...
                            <p>
                                {{ Auth::user()->name }}
                                <br>
                                <span class="badge badge-pill badge-dark">CODE Developer</span>
                            </p>
                        </li>
                        <!-- Menu Body -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/" class="brand-link">
                <img src="{{ asset('dist/img/AdminLTELogo.png') }}" alt="{{ config('app.name', 'Laravel') }} Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/console/chat/101" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Chanel 101</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/console/chat/102" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Chanel 102</p>
                                    </a>
                                </li>
        ...
        <!-- Main Footer -->
        <footer class="main-footer small p-2">
            <!-- To the right -->
